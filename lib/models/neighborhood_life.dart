...
List<NeighborhoodLife> neighborhoodLifeList = [
  NeighborhoodLife(
    category: '우리동네질문',
    profileImgUri: 'https://placeimg.com/100/100/people/grayscale',
    userName: '헬로비비',
    location: '좌동',
    content: '예민한 개도 미용할 수 있는 곳이나 동물 병원 어디 있을까요?\n'
        '내일 유기견을 데려오기로 했는데 아직 성향을 잘 몰라서 걱정이 돼요 ㅜㅜ.',
    contentImgUri: 'https://placeimg.com/100/100/tech/grayscale',
    commentCount: 11,
    authCount: 3,
    date: '3시간전',
  ),
  NeighborhoodLife(
    category: '우리동네소식',
    profileImgUri: 'https://placeimg.com/100/100/people',
    userName: '당근토끼',
    location: '우동',
    content: '이명 치료 잘 아시는 분 있나요?',
    contentImgUri: 'https://placeimg.com/100/100/animal/grayscale',
    commentCount: 2,
    authCount: 1,
    date: '1일전',
  ),
  NeighborhoodLife(
    category: '분실',
    profileImgUri: 'https://placeimg.com/100/100/nature/grayscale',
    userName: 'flutter',
    location: '중동',
  ...
  NeighborhoodLife(
    category: '우리동네질문',
    profileImgUri: 'https://placeimg.com/100/100/any',
    userName: '구름나드리',
    location: '우동',
  ...
  NeighborhoodLife(
    ...
    contentImgUri: 'https://placeimg.com/100/100/tech',
    commentCount: 11,
    authCount: 2,
    date: '5일전',
  ),
